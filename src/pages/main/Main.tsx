...
import { AboutPlatform, FooterUnlockInfo, GeneralCounsel, IntroMain, LogoCompany, Slider, UnlockBlock, UsePlatform, Video } from "../../widgets";
...
export default function Main() {
  return (
    <main>
      ...
      <section className="about_platform max-w-[1370px] py-10">
        <div className="text-center">
          <h3>Augment All of Your Work on</h3>
          <h3>One Integrated, Secure Platform</h3>
        </div>
      ...
      <section className="max-w-[1370px]">
